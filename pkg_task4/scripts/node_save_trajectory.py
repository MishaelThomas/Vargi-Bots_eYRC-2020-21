...
class Ur5Moveit:
    ...
    def __init__(self):
        ...
        self._box_pose.pose.position.x = 0.00
        self._box_pose.pose.position.y = -0.39
        self._box_pose.pose.position.z = 1.42
...
def main():
    ...
    final_pose = [-3.1415599856559107, -0.26754503851681743, -0.0001706684155955429, -1.2683213740666757, -1.4892632351823014, 1.5161846937061796e-05]
    init_pose=[-3.141506391563417, -1.569915578473685, -9.893585598330645e-05, 7.267787673015391e-05, 3.0516974577565747e-05, 4.799584853820704e-05]
    ur5.hard_set_joint_angles(init_pose,3)
    ur5.hard_set_joint_angles(final_pose,3)
    ...
    """wpose = geometry_msgs.msg.Pose()
    wpose.position.x = -0.81725
    wpose.position.y =0.10915
    wpose.position.z =0.94450900
    wpose.orientation.x = -0.99532
    wpose.orientation.y = 0.00037
    wpose.orientation.z = -0.07953
    wpose.orientation.w = 0.00076
    ...
    #print(ur5._group.get_current_pose())
