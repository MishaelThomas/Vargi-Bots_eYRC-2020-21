...
class update_spreadheets:
    ...
    def incoming_orders_sheet(self,order):
        ...
        global URL
        Item=order["item"]
        payload={"Id":"IncomingOrders","Team Id":"VB#1194","Unique Id":"PaThJaPa","Order Id":order["order_id"],"Order Date and Time":order["order_time"],"Item":Item,"Priority":item_data[Item]["Priority"],"Order Quantity":order["qty"],"City":order["city"],"Longitude":order["lon"],"Latitude":order["lat"],"Cost":item_data[Item]["Cost"]}
    ...
    def dispatched_and_shipped_sheet(self,order):
        ...
        payload1={"Team Id":"VB#1194","Unique Id":"PaThJaPa","Order Id":Order_Id,"City":order_info["city"],"Item":order_info["item"],"Priority":item_data[order_info["item"]]["Priority"],"Cost":item_data[order_info["item"]]["Cost"]}
        if order.task_done=="Dispatched":
            ...
            payload2={"Id":"OrdersShipped","Shipped Quantity":"1","Shipped Status":"Yes","Shipped Date and Time":order.Date_and_Time,"Estimated Time of Delivery":item_data[order_info["item"]]["Delivery Time"]}
...
def update_inventory_sheet():
    ...
    for key,value in sort_data.items():
        ...
        iot.spreadsheet_write(URL,payload=
        {"Id":"Inventory","Team Id":"VB#1194","Unique Id":"PaThJaPa","SKU":SKU,"Storage Number":storage_pos,"Cost":item_data[item_color[pkg_color]]["Cost"],"Qunatity":"1","Priority":item_data[item_color[pkg_color]]["Priority"],"Item":item_color[pkg_color]})
